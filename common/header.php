...
<div class="container">
  <a class="navbar-brand" href="<?php echo SITEURL; ?>"><i class="fa fa-address-book"></i> Sanand Parivar</a>
...
if (!empty($user)) {
    ?>
      <li class="nav-item <?php if ($currentPage == SITEURL . "addcontact.php") {echo "active";}?>">
	   ...
	   <li class="nav-item <?php if ($currentPage == SITEURL . "report.php") {echo "active";}?>">
        <a class="nav-link" href="<?php echo SITEURL . "report.php"; ?>">Address Report</a>
      </li>
	  <li class="nav-item <?php if ($currentPage == SITEURL . "member_report.php") {echo "active";}?>">
        <a class="nav-link" href="<?php echo SITEURL . "member_report.php"; ?>">Member List</a>
      </li>
	  <li class="nav-item <?php if ($currentPage == SITEURL . "member_report_name.php") {echo "active";}?>">
        <a class="nav-link" href="<?php echo SITEURL . "member_report_name.php"; ?>">Member Report(Name)</a>
      </li>
	   <li class="nav-item <?php if ($currentPage == SITEURL . "all_member_view.php") {echo "active";}?>">
        <a class="nav-link" href="<?php echo SITEURL . "all_member_view.php"; ?>">All Member View Report</a>
      </li>
