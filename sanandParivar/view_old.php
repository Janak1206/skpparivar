...
<div class="container" id="profile">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-8">
                <h4 class="text-primary"><?php echo $contactResult['member_no'] . " " . $contactResult['member_name']; ?></h4>
                <p class="text-secondary">
                <i class="fa fa-envelope-o" aria-hidden="true"></i> <?php echo $contactResult['email']; ?><br />
                <i class="fa fa-phone" aria-hidden="true"></i> <?php echo $contactResult['mobile_no_1']; ?><br />
				 <i class="fa fa-phone" aria-hidden="true"></i> <?php echo $contactResult['mobile_no_2']; ?><br />
