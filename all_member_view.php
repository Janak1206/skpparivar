...
if (!empty($userId)) {
    ...
    $contactsSql = "SELECT * FROM `contacts` WHERE `owner_id`= $userId ORDER BY id ASC ";
    $conn = db_connect();
...
<?php
while ($contactResult = mysqli_fetch_assoc($contactsResult)) {
...
<img src="<?php echo !empty($contactResult['photo']) ? SITEURL . "uploads/photos/" . $contactResult['photo'] : SITEURL . "uploads/photos/default_image.png" ; ?>" width="150" />
</td>
</tr>
<tr style="height: 14.4pt;">
